...
namespace EmployeeManagementDatabase.Migrations
{
    ...
    [Migration("20241202172842_UpddateTheTablesNames")]
    partial class UpddateTheTablesNames
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagementDatabase.Entities.ExternalLogin", b =>
                {
            ...
            modelBuilder.Entity("EmployeeManagementDatabase.Entities.RoleAddition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RoleAdditions", (string)null);
                });
            ...
            modelBuilder.Entity("EmployeeManagementDatabase.Entities.UserAddition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagementDatabase.Entities.UserAndRole", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeManagementDatabase.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("EmployeeManagementDatabase.Entities.Role", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole", null)
                        .WithOne()
                        .HasForeignKey("EmployeeManagementDatabase.Entities.Role", "Id")
